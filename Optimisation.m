...
if  (p(1)<0)||(p(2)<0)||(p(3)<0);
   ...
   replicas = [1 2 3];
    ...
    for i = replicas
        ...
        tps=tempsexp1(:,i);
        [t,ysim] = ode45(@ResolBilan,tempsexp1(:,i),y0,[],p,I(1),nexp,tps,ts(1,i),Cste_Reacteur);%Résolution équa diff
        y1(:,i) = ysim(:,1);
    end
...
% Replicat 3
    ...
    E=E1_1+E2_1+E3_1+E4_1+E5_1+E1_2+E2_2+E3_2+E4_2+E5_2+E1_3+E2_3+E3_3+E4_3+E5_3; % l'erreur totale cumulé sur l'ensemble des jeux de données
end
